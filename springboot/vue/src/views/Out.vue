<template>
  <div>
    ...
    <div style="margin: 10px 0">
      ...
      <el-upload action="http://localhost:9090/out/import" :show-file-list="false" accept="xlsx" :on-success="handleExcelImportSuccess" style="display: inline-block">
    ...
    <el-table :data="tableData" border stripe header-cell-class-name="headerBg"  @selection-change="handleSelectionChange">
      ...
      <el-table-column prop="gate" label="外出门口" width="100"></el-table-column>
      <el-table-column prop="location" label="目的地"></el-table-column>
      <el-table-column prop="reason" label="外出事由" width="100"></el-table-column>
      <el-table-column prop="specialCase" label="特殊情况"></el-table-column>
    ...
    <el-dialog title="学生出校信息记录" :visible.sync="dialogFormVisible" width="30%">
...
export default {
  ...
  methods: {
    load(){
      this.request.get("http://localhost:9090/out/page",{
        params:{
    ...
    changeEnable(row) {
      this.request.post("/out", row).then(res => {
        if (res) {
