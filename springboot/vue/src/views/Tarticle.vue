...
export default {
  ...
  methods: {
    ...
    load() {
      this.request.get("/tarticle/page", {
        params: {
    ...
    changeEnable(row) {
      this.request.post("/tarticle/update", row).then(res => {
        if (res) {
    ...
    del(id) {
      this.request.delete("/tarticle/" + id).then(res => {
        if (res) {
    ...
    delBatch() {
      ...
      this.request.post("/tarticle/del/batch", ids).then(res => {
        if (res) {
    ...
    save() {
      this.request.post("/tarticle", this.form).then(res => {
        if (res) {
