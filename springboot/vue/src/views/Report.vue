<template>
  <div>
    ...
    <div style="margin: 10px 0">
      ...
      <el-upload action="http://localhost:9090/report/import" :show-file-list="false" accept="xlsx" :on-success="handleExcelImportSuccess" style="display: inline-block">
    ...
    <el-table :data="tableData" border stripe header-cell-class-name="headerBg"  @selection-change="handleSelectionChange">
      ...
      <el-table-column prop="temperature" label="当前体温" width="80"></el-table-column>
      <el-table-column prop="health" label="健康状况" width="100"></el-table-column>
      <el-table-column prop="address" label="当前地址"></el-table-column>
...
export default {
  ...
  methods: {
    load(){
      this.request.get("http://localhost:9090/report/page",{
        params:{
    ...
    exp() {
      window.open("http://localhost:9090/report/export")
    },
